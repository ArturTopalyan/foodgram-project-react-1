# Generated by Django 3.2.13 on 2022-06-25 21:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingridients', models.ManyToManyField(help_text='ингридиенты, необходимые для приготовления блюда', through='recipes.IngridientInRecipe', to='recipes.Ingridient')),
            ],
            options={
                'verbose_name': 'Рецепт',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipes', to='tags.tag')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='recipe',
            name='tags',
            field=models.ManyToManyField(help_text='тэги рецепта', through='recipes.TagInRecipe', to='tags.Tag'),
        ),
        migrations.AddField(
